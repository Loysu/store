...
from .models import Category, CartProduct, Cart, Customer, Notebook
...
class StoreTestCases(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.customer = Customer.objects.create(user = self.user, phone = '+79097524578', address = 'jgweiro hghiorroeg')
