...
class BaseView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        context = {"products": products, "cart": self.cart, "categories": categories}
...
class CategoryDetailView(CartMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for item in self.request.GET:
            ...
            pf = (
                ProductFeature.objects.filter(q_condition_queries)
                .prefetch_related("product", "features")
                .values("product_id")
            )
...
class CheckoutView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        context = {"cart": self.cart, "form": form, "categories": categories}
