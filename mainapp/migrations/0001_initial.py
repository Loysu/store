# Generated by Django 3.1.4 on 2021-03-01 16:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=1024, null=True, verbose_name='Адресс доставки')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий к заказу')),
                ('status', models.CharField(choices=[('payed', 'Заказ оплачены'), ('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов к получению'), ('completed', 'Заказ получен')], default='new', max_length=100, verbose_name='Статус заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.product', verbose_name='Товай')),
