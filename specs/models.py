...
class FeatureValidator(models.Model):
    ...
    feature_key = models.ForeignKey(
        CategoryFeature, verbose_name='Ключ характеристики', on_delete=models.CASCADE, null= True
    )
...
class ProductFeature(models.Model):
    ...
    feature = models.ForeignKey(CategoryFeature, verbose_name='Характеристика', on_delete=models.CASCADE, null= True)
