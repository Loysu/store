...
urlpatterns = [
    ...
    path(
        "feature-choice/", FeatureChoiceView.as_view(), name="feature-choice-validators"
    ),
    path("feature-create/", CreateFeatureView.as_view(), name="create-feature"),
    path(
        "new-product-feature/",
        NewProductFeatureView.as_view(),
    ...
    path(
        "product-feature/",
        ProductFeatureChoicesAjaxView.as_view(),
        name="product-feature",
    ),
    path(
        "attach-new-product-feature/",
        CreateNewProductFeatureAjaxView.as_view(),
        name="attach-new-product-feature",
    ),
    path(
        "update-product-features/",
        UpdateProductFeaturesView.as_view(),
    ...
    path(
        "update-product-features-ajax/",
        UpdateProductFeaturesAjaxView.as_view(),
        name="update-product-features-ajax",
    ),
]
